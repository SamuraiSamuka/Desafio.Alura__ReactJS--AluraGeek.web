  ...
  return (
    <div className="carrinho">
                ...
                return (
                    <li className="carrinho-item" key={produto.id}>
                        ...
                        <div className="carrinho-item-info">
                            ...
                            <h3 className="carrinho-item-preco">{produto.preco}</h3>
                        </div>
        ...
        <div className="carrinho-resumo">
            <h2>Sub total do carrinho</h2>
            <h3>{produtos.reduce((acumulador, valorAtual) => { return acumulador + valorAtual.preco }, 0)}</h3>
